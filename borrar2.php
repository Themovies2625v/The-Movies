...
<header>
    ...
    <?php
            ...
            if(mysqli_num_rows($result)>0){
                $query2 ="DELETE FROM  usuarios where nombre= '".$n."'";
                ...
                echo"<font color = '#FFFFFF' class='titulo'>Usuario eliminado</font>";
                ...
                echo"<script> alert('El usuario $n ha sido eliminado de forma correcta')</script>";
            }
            else{
                echo"<font color = '#FFFFFF' class='titulo'>Usuario no encontrado</font>";
                echo"<script> alert('El usuario $n no pudo ser eliminado, ya que no existe')</script>";
            }
