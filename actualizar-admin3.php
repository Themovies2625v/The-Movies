...
<header>
    ...
    <?php
        ...
        $query1="UPDATE administradores SET correo= '$c_e', pasword = '$c', celular = '$celular' where nombre ='".$n."'";
        $result1= mysqli_query($link, $query1) or die("consulta fallida".mysqli_error());
        echo"<font color = '#FFFFFF' class='titulo'>El administrador $n ha sido actualizado</font>";
        }
        else{
