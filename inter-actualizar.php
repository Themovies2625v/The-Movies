...
<header>
      ...
      <center>
        <div class="encuesta">
          <div class="preguntas">
            <h3><i>Ingresa el nombre de usuario ha actualizar</i></h3>
            <form class="registro" action="inter-actualizar2.php" method="post">
  						<div>
  							<label>Nombre</label><br><br>
  							<input type="text" placeholder="Nombre de usuario" name="nombre" required>
  						</div>
                          <br>
  						<input class="boton-iniciar" type="submit" name="boton" value="Buscar">
					</form>
          </div>
        </div></center>
