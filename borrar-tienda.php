...
<header>
    ...
    <?php
            ...
            if(mysqli_num_rows($result)>0){
                $query2 ="DELETE FROM  peliculas where codigo= ".$c;
                $result2= mysqli_query($link, $query2) or die("consulta fallida".mysqli_error());
                echo"<center><table>
                <thead>
                <tr>
                    <th>nombre</th> <th>Correo</th> <th>Contraseña</th> <th>Celular</th><th>Perfil</th>
                </tr></thead>";
                echo"<font color = '#FFFFFF' class='titulo'>Producto eliminado</font>";
                ...
                echo"<script> alert('El producto ha sido eliminado de forma correcta')</script>";
            }
            else{
                echo"<font color = '#FFFFFF' class='titulo'>Producto no encontrado</font>";
                echo"<script> alert('El producto con el codigo: $c no pudo ser eliminado, ya que no existe')</script>";
            }
